...
class Hxin(object):
    """画像接口"""
    login_url = 'https://apt1.100credit.cn/bankServer2/user/login.action'
    query_url = 'https://apt1.100credit.cn/bankServer2/data/terData.action'
    haina_api_url = 'http://192.168.22.209:8081/HainaApi/data/getData.action'
    ...
    def get_data(self, params, modal):
        """获取返回json"""
        if len(modal) == 1 and modal[0] in ['TelCheck', 'TelPeriod', 'TelStatus']:
