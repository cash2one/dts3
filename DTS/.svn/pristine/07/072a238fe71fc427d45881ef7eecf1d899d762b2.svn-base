...
class Member(models.Model):
    ...
    permission = models.TextField(max_length=65535, default='x:0', blank=True, verbose_name='接口权限', help_text='接口名称：匹配数量')
    ty3 = models.TextField(max_length=65535, default='x:0', blank=True, verbose_name='通用3权限', help_text='接口名称：匹配数量')
    xd3 = models.TextField(max_length=65535, default='x:0', blank=True, verbose_name='信贷3权限', help_text='接口名称：匹配数量')
    ty4 = models.TextField(max_length=65535, default='x:0', blank=True, verbose_name='通用4权限', help_text='接口名称：匹配数量')
    xd4 = models.TextField(max_length=65535, default='x:0', blank=True, verbose_name='信贷4权限', help_text='接口名称：匹配数量')
